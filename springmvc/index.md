...
<web-app xmlns="http://xmlns.jcp.org/xml/ns/javaee"
    ...
    <servlet>
        ...
        <servlet-class>com.miaobuyi.servlet.HelloServlet</servlet-class>
    </servlet>
    <servlet-mapping>
        <servlet-name>hello</servlet-name>
...
3. - @Controller是为了让Spring IOC容器初始化时自动扫描到；
...
1. DispatcherServlet表示前置控制器，是整个SpringMVC的控制中心。户发出请求,
DispatcherServlet接收请求并拦截请求。
* 我们假设请求的url为: http://localhost:8080/SpringMVC/hello
*  如上url拆分成三部分:
*  http://localhost:8080服务器域名
*  SpringMVC部署在服务器.上的web站点
* hello表示控制器
*  通过分析，如上urI表示为:请求位于服务器localhost:8080上的SpringMVC站点的hello控制器。
2. HandlerMapping为处理器映射。DispatcherServlet调用
HandlerMa pping, HandlerMapping根据请求url查找Handler。
...
jdbc.url=jdbc:mysql://localhost:3306/ssmbuild?useSSL=true&useUnicode=true&characterEncoding=utf8&ServerTimezone=Asia/Chongqing
jdbc.username=root
